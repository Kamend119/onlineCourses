...
import com.example.onlinecourses.network.MyCoursesViewModel
import com.example.onlinecourses.ui.theme.OnlineCursesTheme
import kotlinx.coroutines.launch

@Composable
fun MainMyCourses(navController: NavHostController, userId: String) {
    val viewModel: MyCoursesViewModel = viewModel()
    val focusManager = LocalFocusManager.current
    var searchQuery by remember { mutableStateOf("") }
    var filteredCourses by remember { mutableStateOf(viewModel.courses.value) }
    ...
    LaunchedEffect(Unit) {
        ...
        viewModel.fetchCourses(userId.toInt())
    }
    ...
    OnlineCursesTheme {
        AppBarStudent( title = "Мои курсы", showTopBar = true, showBottomBar = true, navController = navController, userId = userId
        ) {
                        ...
                        Row(
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.buttonColors(
                                    containerColor = if (selectedCategories.isNotEmpty())
                                ...
                                Card(
                                    modifier = Modifier
                                        ...
                                        .clickable {
                                            ...
                                            navController.navigate("mainCourses/${userId}/${courseId}")
                                        }
                                        .padding(vertical = 8.dp),
